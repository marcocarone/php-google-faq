...
<body>
  <header>
    <div class="wrapper">
      <div class="top-box">
        <div class="logo">
          <img src="public/img/logo.png" alt="logo google">
        </div>
    ...
    <div class="wrapper">
      ...
      <h2>
        <?php
            ...
            <?php foreach ($key["risposta"] as $risposta) { ?>
